                    ...
                    <div className="w-full lg:w-2/3">
                        ...
                        <div className="mt-3 grid grid-cols-5 gap-2">
                            {venue.images.map((image, index) => (
                                <div key={index} className="relative rounded-lg overflow-hidden cursor-pointer hover:opacity-90 transition-opacity">
                                    <img
                                        src={image}
                        ...
                        <div className="bg-white rounded-lg shadow-lg w-full max-w-md relative">
                            ...
                            <div className="p-6">
                                ...
                                <form className="space-y-4">
                                    ...
                                    <div className="pt-2">
                                        <Button className="w-full">Randevu Talep Et</Button>
                                    </div>
                                    ...
                                    <div key={item.id} className="border-b border-border pb-6 last:border-0 last:pb-0">
                                        <div className="mb-3">
                                            <div className="flex items-start gap-3 mb-2">
                                                <div className="bg-primary/10 text-primary p-2 w-8 h-8 flex items-center justify-center rounded-full">
                                        ...
                                        {item.answer ? (
                                            <div className="ml-8">
                                                <div className="flex items-start gap-3">
                                                    <div className="bg-green-100 text-green-600 p-2 w-8 h-8 flex items-center justify-center rounded-full">
                                            ...
                                            <div className="ml-8 text-sm text-darkgray italic">
